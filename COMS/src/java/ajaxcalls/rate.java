...
public class rate extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
//        processRequest(request, response);
        String rating,paper_ID,rev_ID,conf_ID;
        rating = request.getParameter("rating").toString();
        paper_ID = request.getParameter("paper_ID").toString();
        String sql = "UPDATE reviews SET rating='" + rating + "' WHERE paper_ID='" + paper_ID + "'";
